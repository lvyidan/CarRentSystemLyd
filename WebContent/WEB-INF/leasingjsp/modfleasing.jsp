...
<html>
  <head>
    ...
    <title>My JSP 'modfleasing.jsp' starting page</title>
 ...
 <form action="mainleasing" method="post">
    <table width="95%" align="center" border="0" cellpadding="0" cellspacing="1">
	  <tr>
		...
		<td width="200" align="center"><input type="text" name="rtime" id="rtime" onBlur="adds()" value="${leasing.rtime}"></td>
	  ...
	  <tr>
	     <td colspan="4" align="center">
		   	<input type="hidden" name="method" value="modf">
