   ...
   <form action="ordercar" method="post">
    <table width="95%" align="center" border="0" cellpadding="0" cellspacing="1">
	  <tr>
		...
		<td width="200" align="center"><input type="text" name="number" value="${car.number}" readonly></td>
		<td width="200" align="center">每月租金</td>
		<td width="200" align="center"><input type="text" name="price" id="price" value="${car.price}" readonly></td>
	  </tr>
	  	  <tr>
	  ...
	  <tr>
	     <td colspan="4" align="center">
			...
			<input type="submit" value="提交订单" style="cursor: pointer">
		 </td>
	  </tr>
	</table>
	</form>
		  <center>
	    <div align="center"><a href="ordercar">返回</a></div>
	  </center>
  </body>
</html>
